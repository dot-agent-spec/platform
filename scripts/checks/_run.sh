...
# Declared disablement (Plan-020 Track 3): two checks had pre-existing findings at the moment the gate
# was wired here — 35 stale cross-references across old pre-release and RFC documents, and AGENTS.md
# over its line budget. Declared off rather than fixed here: a gate handed over red is the one most
# people switch off within the week. Tracked as debt, not silently dropped — greppable via
# VIBE_OPS_DISABLED_CHECKS across the workspace.
export VIBE_OPS_DISABLED_CHECKS="links:35 pre-existing stale cross-references, predating this rollout (2026-08-07)
budget:AGENTS.md is 174 lines, over the 150-line budget, predating this rollout (2026-08-07)"
